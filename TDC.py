...
print('Suma=',suma(a,b))
print('Produsul',produsul(a,b))
print('Media ARITMETICA=',m_aritmetica(a,b))
print('Cel mai mare divizor=',M_divizor(a,b))
print ('Cel mai mic multiplu comun=',m_multiplu(10,20))
print('Numarul minim',min(a,b))
print('Numarul maxim',max(a,b))
print('Suma numerelor citite',suma_nr_citite())
print('Produsul numerelor citite',produsul_nr_citite())
print('Toti divizorii comuni=',toti_div_com())
print('Cinci multipli=',cinci_multipli())